            ...
            <div id="workExperience">
              <div className="workExperienceDiv m-2">
                ...
                <ul className="workExperienceList text-md">
                  <li>Develop and maintain creative advertising templates for brands such as British Airways, Volkswagen, Porsche, Harley-Davidson, and John Lewis. Build the templates with HTML, CSS & JavaScript, ensuring responsiveness across desktop and mobile devices.</li>
